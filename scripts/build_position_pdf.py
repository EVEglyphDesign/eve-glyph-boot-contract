...
OUT = "/home/user/workspace/ebc/docs/position/EVEglyphDesign_Additive_Position.pdf"
TS = datetime.datetime.now(datetime.timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
DOC_ID = "EgD-POS-001"; KEY_ID = "EgD-KEY-2026-07"
TITLE = "The Additive Position"
SUB = ("Who EVEglyph Design technology is made available to, on what terms, and how it "
...
def paint(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, H - 15*mm,
                      "EVEglyphDesign  \u00b7  The Additive Position  \u00b7  " + DOC_ID)
...
def cover(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, y + 34*mm, "E V E G L Y P H D E S I G N   \u00b7   P O S I T I O N   P A P E R")
