#!/usr/bin/env python3
"""Render EgD-POS-001.md into the public /position/ page. Single source of truth."""
import re, hashlib

SRC = "/home/user/workspace/ebc/docs/position/EgD-POS-001.md"
OUT = "/home/user/workspace/ebc/docs/position/index.html"
RAW = open(SRC, encoding="utf-8").read()
SHA = hashlib.sha256(RAW.encode("utf-8")).hexdigest()
DECK = ("Who EVEglyph Design technology is made available to, on what terms, and how it "
        "enters an enterprise estate without competing with the vendor already in it.")
...
<title>The Additive Position \u2014 EgD-POS-001 \u00b7 EVEglyphDesign</title>
...
<section class="hero">
  ...
  <div class="cta">
    <a class="btn" href="EVEglyphDesign_Additive_Position.pdf">Read the controlled PDF &rarr;</a>
...
<footer>
  ...
  <a href="EVEglyphDesign_Additive_Position.pdf">Controlled PDF</a> \u00b7
