...
OUT = "/home/user/workspace/ebc/docs/strategy/EVEglyphDesign_Review_Path.pdf"
TS = datetime.datetime.now(datetime.timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
DOC_ID = "EgD-STR-001"; KEY_ID = "EgD-KEY-2026-07"
TITLE = "The Review Path"
SUB = ("How EVEglyph Design gets read, checked and cited by people who already hold the audience we need — without buying attention and without a content programme.")
...
def paint(canvas, doc):
    ...
    canvas.drawString(MARGIN_L, H - 15*mm,
                      "EVEglyphDesign  \u00b7  The Review Path  \u00b7  " + DOC_ID)
