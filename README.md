...
| [`registry/SIN-DEFECTS.md`](./registry/SIN-DEFECTS.md) | The defect register. Every logged breach with the class, what was asked, what was done instead, the cheaper path that existed, and the estimated waste |
