...
| [`registry/RECORD-OF-DEFECTS.md`](./registry/RECORD-OF-DEFECTS.md) | The defect register. Every logged breach with the class, what was asked, what was done instead, the cheaper path that existed, and the estimated waste |
...
[`registry/RECORD-OF-DEFECTS.md`](./registry/RECORD-OF-DEFECTS.md) for the live register.
...
[`registry/RECORD-OF-DEFECTS.md`](./registry/RECORD-OF-DEFECTS.md) — the Record of
Defect, renamed from `SIN-DEFECTS.md` on 2026-09-09, prior entry IDs unchanged — in the
same working session, after the operator's actual request has been satisfied, never
before it. New entries use `ROD-YYYY-MM-DD-NN`.
