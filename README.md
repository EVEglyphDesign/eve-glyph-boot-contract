...
| [`registry/RECORD-OF-SUFFERING.md`](./registry/RECORD-OF-SUFFERING.md) | The **Record of Suffering (ROS)** — the register kept from the operator's perspective. Every logged breach carries a **class** (shape of the miss) and a **fault rank** (who caused the operator to bear the cost: Agent, Instruction, Tooling / Platform, or Upstream), plus what was asked, what was done instead, the cheaper path that existed, and the estimated waste. Supersedes `RECORD-OF-DEFECTS.md` (2026-09-12) and `SIN-DEFECTS.md` (2026-09-09); prior entry IDs are unchanged |
...
[`registry/RECORD-OF-SUFFERING.md`](./registry/RECORD-OF-SUFFERING.md) for the live
register.
...
[`registry/RECORD-OF-SUFFERING.md`](./registry/RECORD-OF-SUFFERING.md) — the **Record
